                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <ul >
                                        ...
                                        if (@$_GET['q'] == 0)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item" href="dash.php?q=0">Home<span class="sr-only">(current)</span></a></li>
                                                <li <?php
                                        if (@$_GET['q'] == 1)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item"href="dash.php?q=1">Users</a></li>
                                            <li <?php
                                        if (@$_GET['q'] == 2)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item"href="dash.php?q=2">Leaderboard</a></li>
                                            <li <?php
                                        if (@$_GET['q'] == 3)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item" href="dash.php?q=3">Feedback</a></li>
                                                <li <?php
                                        if (@$_GET['q'] == 4)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item" href="dash.php?q=4">Add Quiz</a></li>
                                                <li <?php
                                        if (@$_GET['q'] == 5)
                                            echo 'class="active"';
                                        ?>><a class="dropdown-item" href="dash.php?q=5">Remove Quiz</a></li>
                                            </ul>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Rollno</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Phno</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        $phno      = $row['phno'];
  ...
  <td style="vertical-align:middle"><a title="Delete User" href="update.php?dusername=' . $username1 . '"><b><span class="btn logb" style="color:#FFFFFF;background:#ff0000;font-size:12px;padding:5px;">&nbsp;<span><b>Delete</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Date</b></td><td style="vertical-align:middle"><b>Time</b></td><td style="vertical-align:middle"><b>By</b></td><td style="vertical-align:middle"></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
  ...
  <td style="vertical-align:middle"><a title="Open Feedback" href="dash.php?q=3&fid=' . $id . '"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
        echo '<td style="vertical-align:middle"><a title="Delete Feedback" href="update.php?fdid=' . $id . '"><b><span class="btn logb" style="color:#FFFFFF;background:#ff0000;font-size:12px;padding:5px;" aria-hidden="true"><b>Delete</b></span></b></a></td></tr>';
    }
    echo '</table></div>';
}
if (@$_GET['fid']) {
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    echo ' 
<div class="row">
<span class="title1 d-flex justify-content-center mx-auto" style="margin-left:70%;font-size:30px;"><b>Enter Quiz Details</b></span><br /><br />
 <div class="col-md-10"></div><div class="col-md-12">   <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
<fieldset>
...
<div class="row">
<span class="title1 d-flex justify-content-center mx-auto" style="margin-left:40%;font-size:40px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-10"></div><div class="col-md-12"><form class="form-horizontal title1" name="form" action="update.php?q=addqns&n=' . @$_GET['n'] . '&eid=' . @$_GET['eid'] . '&ch=4 "  method="POST">
<fieldset>
