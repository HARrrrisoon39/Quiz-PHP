...
<div class="col-lg-6">
<span class="logo">Feedback Form</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
if ((!isset($_SESSION['username']))) {
    echo '<a href="index.php" class="pull-right btn logb btn-primary" style="color:white"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Home</font></a>&nbsp;';
} else {
...
<div class="col-md-10 panel" style="background-image:url(https://cdn.pixabay.com/photo/2017/03/14/16/57/silver-2143730__340.jpg); min-height:430px;margin-left:50px;">
<div class="alert alert-dark" role="alert">
<p style="color: #ffffff; background-color: #000000;font-size: 40px;text-align: center;">FEEDBACK</p>
</div>
